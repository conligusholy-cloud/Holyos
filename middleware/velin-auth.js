// =============================================================================
// HolyOS — Velín: middleware pro mobilní API (device token auth)
// =============================================================================
...
//
// req.velin = { person, device } po úspěšné autentizaci.

const { prisma } = require('../config/database');
const { verifySecret } = require('../services/velin/auth');

async function requireVelinDevice(req, res, next) {
  try {
...
module.exports = { requireVelinDevice };
