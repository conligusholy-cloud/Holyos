/* ============================================
   config.ts — Konstanty a konfigurace
   ============================================ */

import type { Dimensions, EntranceType, ObjectType } from '../../../shared/types.js';
...
export const DEFAULT_SIZES: DefaultSizesConfig = {
  areal:      { w: 100, h: 80 },
  hala:       { w: 40, h: 25 },
  pracoviste: { w: 6, h: 4 },
  sklad:      { w: 15, h: 10 },
...
export const POLYGON_TYPES: ObjectType[] = ['areal', 'hala', 'cesta'];

// Typy které se kreslí jako obdélník (drag & drop)
export const RECT_TYPES: ObjectType[] = ['pracoviste', 'sklad', 'vstup'];
...
export const ENTRANCE_TYPES: EntranceTypesConfig = {
