...
// Spotřeba na JEDEN cyklus podle stroje (V3): elektřina, voda, prášek, aviváž + cena v EUR.
// Reálná spotřeba se liší dle naplnění bubnu prádlem.
function deriveCycleSpec(cfg) {
  const d = Object.assign({}, UNIT_V3, cfg || {});
  const vodne = d.cena_vodne + d.cena_stocne;
...
module.exports = {
  sourceCurrencyForCode, convert, toBase, deriveUnitModelPct, deriveServiceBreakdown, deriveEnergyBreakdown, deriveCycleSpec,
