import type { DrawingObject, Point, ObjectType, EntranceType, RoomLabel, Entrance } from '../../../shared/types.js';
export declare function createObject(type: ObjectType, x: number, y: number): DrawingObject;
export declare function createPolygonObject(type: ObjectType, points: Point[]): DrawingObject | null;
...
export declare function updateProp(key: keyof DrawingObject, value: any): void;
...
export declare function rotateRect(objId: number, angleDeg: number): void;
export declare function setRectRotation(objId: number, angle: number): void;
...
export declare function updateEntranceProp(objId: number, entranceId: number, key: keyof Entrance, value: any): void;
...
export declare function findNearestArealEdge(wx: number, wy: number): EdgeHit | null;
...
export declare function findNearestWall(obj: DrawingObject, wx: number, wy: number): WallHit | null;
...
export declare function projectOntoWall(obj: DrawingObject, wallId: number, wx: number, wy: number): WallProjection | null;
...
export declare function updateRoomLabelProp(objId: number, roomId: number, prop: keyof RoomLabel, value: any): void;
