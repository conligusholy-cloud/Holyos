...
import { dom, screenToWorld, snapToGrid, updateTransform, resizeSVG, renderAll, getPolygonBBox } from './renderer.js';
import { selectObject, findObjectAt, deleteObject, duplicateObject, createObject, deselectAll } from './objects.js';
...
// SPLIT HANDLE
// ============================
export function initSplitHandle() {
    const handle = document.getElementById('split-handle');
    const topSection = document.getElementById('top-section');
    const bottomPanel = document.getElementById('bottom-panel');
    if (!handle || !topSection || !bottomPanel)
        return;
