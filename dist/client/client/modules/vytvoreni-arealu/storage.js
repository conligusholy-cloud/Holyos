...
import { renderAll, dom } from './renderer.js';
...
export function saveAllSimulations(sims) {
...
export function initPersistentStorage() {
    return Promise.resolve(PersistentStorage.migrateFromLocalStorage([STORAGE_KEY])).then(() => PersistentStorage.init([STORAGE_KEY]));
}
