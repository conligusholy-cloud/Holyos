...
// =============================================================================
// Persistujeme:
//   - holyos_jwt   — token z /api/auth/login (24 h platnost, default JWT_EXPIRY)
//   - person_id    — připojený Person, kterého uvidí na obrazovkách
//   - display_name — pro hezký pozdrav
//
...
export async function loadAuth(): Promise<AuthSnapshot> {
  const [jwt, personId, displayName, username] = await Promise.all([
