...
function renderSidebar(activeModule) {
  var modules = [
    ...
    { id: 'prekladac',            name: 'Překladač',           icon: '&#128483;', color: '#4ecdc4', active: true },
    { id: 'spare-parts',          name: 'Spare Parts Shop',    icon: '&#128722;', color: '#f59e0b', active: true },
    { id: 'doprava',              name: 'Doprava',             icon: '&#128666;', color: '#a78bfa', active: true },
  ...
  // Nenásilné hlídání nové verze aplikace (banner „obnovit", nic nevynucuje).
  initVersionWatcher();
}

// Sledování nasazené verze: když se na serveru změní build (nový deploy), ukáž
// nahoře lištu „je nová verze — obnovit". Nic nevynucuje — uživatel pracuje dál na
// staré verzi, data se ukládají normálně, a přepne se, až sám klikne na Obnovit.
function initVersionWatcher() {
  ...
  function showBanner(nv) {
    ...
    bar.innerHTML = '<span>🔄 Je dostupná nová verze HolyOS. Dokonči a ulož rozdělanou práci a obnov, až se ti to bude hodit.</span>'
