...
//   RCCP V2 scheduling: nastaví planned_start/planned_end pro každou BatchOperation
//   s ohledem na shift (env SCHEDULER_SHIFT_*), queue na pracovišti a SlotBlock.
//   Body (optional): { exclusive: true } — ignoruje frontu jiných dávek (re-plán od nuly).
...
// POST /api/planning/schedule-all
//   Bulk re-plán všech aktivních dávek (planned/released/paused).
//   Před spuštěním promaže planned_start/end u non-started operací,
//   pak řadí dávky podle priority DESC, planned_end ASC a postupně volá scheduleBatch.
//   Vrací souhrn { total, ok, failed, results: [...] }.
